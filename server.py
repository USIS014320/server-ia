...
Conversor = pd.read_csv("C:\Ingieneria en Sistemas y Redes Informaticas\Ciclo IV\Programació Computacional III\Semana 13 (PARCIAL II)\server-ia\cel a fa.csv", sep=";")
sb.scatterplot(Conversor["celcius"], Conversor["fahrenheit"])
...
historial = modelo.fit(C,F,epochs=500, verbose=0)
